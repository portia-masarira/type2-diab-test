...
$(document).ready(function() {
    ...
    $("#mobile-collapse").on("click", function() { if (b > 991) { $(".pcoded-navbar:not(.theme-horizontal)").toggleClass("navbar-collapsed") } });
    $(".mob-toggler").on("click", function() { $(".pcoded-header > .collapse,.pcoded-header > .container > .collapse").toggleClass("d-flex") });
    $(".search-btn").on("click", function() {
        var c = $(this);
        $(".main-search").addClass("open");
        if (b <= 991) { $(".main-search .form-control").css({ width: "90px" }) } else { $(".main-search .form-control").css({ width: "150px" }) }
    });
    ...
    if (!$(".pcoded-navbar").hasClass("theme-horizontal")) { var b = $(window)[0].innerWidth; if ($(".navbar-content")[0]) { if (b < 992 || $(".pcoded-navbar").hasClass("menupos-static")) { var a = new PerfectScrollbar(".navbar-content", { wheelSpeed: 0.5, swipeEasing: 0, suppressScrollX: !0, wheelPropagation: 1, minScrollbarLength: 40, }) } else { var a = new PerfectScrollbar(".navbar-content", { wheelSpeed: 0.5, swipeEasing: 0, suppressScrollX: !0, wheelPropagation: 1, minScrollbarLength: 40, }) } } }
    $(".card-option .close-card").on("click", function() {
        ...
        setTimeout(function() { c.parents(".card").remove() }, 1500)
    });
    ...
    $(".card-option .minimize-card").on("click", function() {
        ...
        if (!c.hasClass("full-card")) { $(c).css("height", "auto") }
    ...
    $(".card-option .full-card").on("click", function() {
        ...
        if (d.hasClass("full-card")) {
            ...
            $("body").css("overflow", "");
            d.removeAttr("style");
            setTimeout(function() { $("html,body").animate({ scrollTop: ($(d).offset().top) - 70 }, 500) }, 400)
        }
    });
